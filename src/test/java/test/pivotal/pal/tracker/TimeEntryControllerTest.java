...
public class TimeEntryControllerTest {
    ...
    private CounterService cService;
    private GaugeService gService;
    @Before
    public void setUp() throws Exception {
        timeEntryRepository = mock(TimeEntryRepository.class);
        cService = mock(CounterService.class);
        gService = mock(GaugeService.class);
        controller = new TimeEntryController(timeEntryRepository,cService,gService);
    }
